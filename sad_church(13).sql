...
CREATE TABLE `tbl_requirementtype` (
  ...
  CONSTRAINT `tbl_id` FOREIGN KEY (`int_wedcaseID`) REFERENCES `tbl_weddingcases` (`int_weddingcaseID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2018-07-20 18:55:29
